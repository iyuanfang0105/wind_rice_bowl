...
# %%
print(df.head())
print('num_user: {}, num_item: {}'.format(num_users, num_items))
...
d2l.train_recsys_rating(net, train_iter, test_iter, loss,
                        trainer, num_epochs, devices, evaluator, inter_mat=test_inter_mat)

# %%
pred = net.forward(train_inter_mat)
