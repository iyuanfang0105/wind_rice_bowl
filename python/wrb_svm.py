...
data_dir = '/Users/wind/WORK/wind_rice_bowl/code/wind_rice_bowl/data/svm'
fr = open(os.path.join(data_dir, 'testSet.txt'))  # this file was generated by 2normalGen.py
